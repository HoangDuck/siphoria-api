...
type Hotel struct {
	...
	HotelType       *HotelType     `json:"hotel_type,omitempty" gorm:"constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
	HotelFacility   *HotelFacility `json:"hotel_facility,omitempty" gorm:"constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
